...
class SqliteDailyPricesCache(AbstractDailyPricesCache):
    """SqlitetDailyPricesCache stored daily price data in a local sqlite db.

        Implements the following methods from AbstractDailyPricesCache:
    ...
    def check_for_missing_dates(self, symbol: str, date_list: List[str]) -> List[str]:
        ...
        """
        raise NotImplementedError('SqliteDailyPricesCache is an abstract base class')
